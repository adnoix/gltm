...
<div class="wrap">
    ...
    <div class="ui_padding30">
        ...
        <div class="ui_sfyz_c2 clearfix">
            <div class="ui_color3">手机号</div>
            <input type="text" class="ui_ipttxt2 ui_border" placeholder="请输入验证手机号码">
            <div class="bk20"></div>
        ...
        <div class="bk40"></div>
        <div class="bk40"></div>
        <a href="sjyztj.html"><input type="submit" value="下一步" class="ui_iptbtn ui_color2"></a>
        <div class="bk30"></div>
        <a href="yxyz.html"><input type="button" value="通过邮箱进行身份验证" class="ui_iptbtn2"></a>
    </div>
</div>
