...
return  array(
    ...
    'MODULE_ALLOW_LIST'     => array('Admin','Home'), //分组
    ...
    'COOKIE_PREFIX'         => 'SPA', // Cookie前缀 避免冲突
    ...
    'DB_NAME'               => 'gltm', // 数据库名
    'DB_USER'               => 'root', // 用户名
    'DB_PWD'                => 'w3WsVAib4CWcxr0LU5j7XQ', // 密码
    'DB_PORT'               => '3306', // 端口
    'DB_PREFIX'             => 'gltm_', // 数据库表前缀
    ...
    //扩展配置
    'LOAD_EXT_CONFIG'       => 'regular,other,alipay',
    'LOAD_EXT_FILE'         => 'Upload',

    //api路径
    //'API_URL'               => 'http://192.168.1.157/Divide',
    //缩略图前缀
    'THUMB_PREFIX'          => 'thumb_'
);